...
function NGODataRegistration(){
  ...
  <div className="mb-3">
    ...
    <input onChange={handleChange} type="number" name = "registeredID" className="form-control" required />
  </div>
  <div className="mb-3">
...
<h5 class = "mb-4">Age group</h5>
    ...
    <input onChange={handleChange} type="number" name = "under18" className="form-control" required />
    </div>
    <div class = "col-md-4">
    <label className="form-label">Number of Beneficiaries over 60</label>
    <input onChange={handleChange} type="number" name = "above60" className="form-control" required />
        </div>
        <div class = "col-md-4">
        <label className="form-label">Number of Female Beneficiaries</label>
    <input onChange={handleChange} type="number" name = "femaleBeneficiariesReached" className="form-control" required />
        </div>
        </div>
</div>
  <div className="mb-3">
    <label className="form-label">Total number of Beneficiaries reached</label>
    <input onChange={handleChange} type="number" name = "numberOfBeneficiariesReached" className="form-control" required />
  </div>
  <div className="mb-3">
    <label className="form-label">Location Covered </label>
    <input onChange={handleChange} type="number" name = "locationCovered" className="form-control" required />
  </div>
  <div className="mb-3">
  ...
  <div className="mb-3">
    ...
    <input type="date" name = "programDate" className="form-control" required />
  </div>
