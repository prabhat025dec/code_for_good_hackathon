      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            className="form-control"
            placeholder="Enter Your Enrolled Program"
            required
          />
        </div>
        <div className="mb-3">
        ...
        <div className="mb-5">
          ...
          <input
            ...
            name="foodAmount"
            className="form-control"
            placeholder="Enter amount of food received(in kg)"
            required
          />
        </div>
        <div class="mb-3">
          <div class="row">
            ...
            <div class="col-md-4">
              <label className="form-label">
                Number of Beneficiaries over 60
              </label>
              <input
                onChange={handleChange}
                type="text"
            ...
            <div class="col-md-4">
              ...
              <input
                onChange={handleChange}
                type="text"
                name="femaleBeneficiariesReached"
                className="form-control"
                required
              />
            </div>
        ...
        <div className="mb-3">
          <label className="form-label">
            Was this food be distributed to any other charity partners from your
            network. If yes, please share the partner names
          </label>
          <input
            onChange={handleChange}
            type="text"
            name="foodDistributedToAnyOtherCharity"
            className="form-control"
            required
          />
        </div>
        ...
        <div class="d-grid gap-2 col-6 mx-auto">
          <button onClick={handleSubmit} class="btn btn-primary" type="button">
            Submit
          </button>
        </div>
      </form>
